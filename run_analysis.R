...
setwd("C:\\Users\\moshyka\\Documents\\Financial\\2014_Annual\\Coursera_data_cleaning\\Project\\UCI HAR Dataset")
...
casted_data <- cast(melted_data, activity ~ patient_id ~ variable, mean)
melted_data2 <- melt(casted_data, id = c("patient_id"))
library(MASS)
write.matrix(melted_data, './test_data.txt', sep = "\t")
getwd()
